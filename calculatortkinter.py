...
# Driver code. To call the functions defined above.
if __name__ == "__main__": 
	...
	expression_field = Entry(gui, textvariable=equation,bg ="darkgreen",fg="white") 
	...
	# creating  Buttons and place at a particular location inside the root window . when user press the button, the command or function affiliated to that button is executed . 
	...
	label = Label(gui,text = "by PRS" ,font = "bold ",fg = "white",bg = "black" )
